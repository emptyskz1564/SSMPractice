					...
					<div class="col-md-4 data">
						<label>
							<input type="text" class="form-control" placeholder="订单编号"
								value="${orders.orderNumber }" readonly="readonly">
						</label>
					</div>
	...
	${orders.orderDesc }
							...
							<tr>
								...
								<td><label>
									<input type="text" size="20"
										value="${traveller.phoneNumber }" readonly="readonly">
								</label></td>
								<td><label>
									<input type="text" size="15"
										value="${traveller.credentialsType}" readonly="readonly">
								</label></td>
								<td><label>
									<input type="text" size="28"
										value="${traveller.credentialsNumber }" readonly="readonly">
								</label></td>
							</tr>
						</c:forEach>
			...
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data text">${orders.memeber.nickName }</div>

					<div class="col-md-2 title">联系人</div>
					<div class="col-md-4 data text">${orders.memeber.name}</div>

					<div class="col-md-2 title">手机号</div>
					<div class="col-md-4 data text">${orders.memeber.phoneNumber}</div>

					<div class="col-md-2 title">邮箱</div>
					<div class="col-md-4 data text">${orders.memeber.email}</div>
