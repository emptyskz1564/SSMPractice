			...
			<section class="content">
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<table id="dataList"
								...
								<thead>
									<tr>
										<th class="" style="padding-right: 0;"><label for="selall"></label><label
												for="selall"></label><input
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            总共2 页，共14 条数据。 每页
							<label for="changePageSize"></label><select class="form-control" id="changePageSize" onchange="changePageSize()">
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
